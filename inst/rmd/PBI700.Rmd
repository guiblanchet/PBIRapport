...
# Afficher les résultats
  ...
  for(j in 1:nrow(sel)){
    ...
    Note_finale <- sel$`Introduction et mise en contexte - Note`[j] * 0.1 +
                   sel$`Rigueur scientifique - Note`[j] * 0.15 +
                   sel$`Pédagogie - Note`[j] * 0.6 +
                   sel$`Réponse aux questions - Note`[j] * 0.15
